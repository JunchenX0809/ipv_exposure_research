...
| **MODIS FRP intensity / FRP density** | Adds fire intensity/severity information beyond burned area or active-fire presence. | [Giglio 2016](https://www.sciencedirect.com/science/article/pii/S0034425716300827); [Li 2018](https://agupubs.onlinelibrary.wiley.com/doi/full/10.1029/2017jd027823). No FRP-density-specific source confirmed. | **Strongest candidate add-on**, but aggregation choice is ours. |
...
| Fornacca, Ren & Xiao (2017). *Performance of three MODIS fire products and ESA Fire_CCI in an area of frequent small fires.* Remote Sensing 9(11), 1131. | https://www.mdpi.com/2072-4292/9/11/1131 | Product comparison in a small-fire setting. |
